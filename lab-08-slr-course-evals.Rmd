...
evals %>%
  ...
  ggtitle("Scatter plot of Average Beauty Rating to Average Evaluation Score")
```
...
***For an average beauty increased by 1 the average evaluation rating goes up by 0.07.***
...
7.  Interpret the intercept of the linear model in context of the data.
    ...
    ***For an average beauty rating of 0, the average evaluation is 3.88. This doesn't make sense in the data since there are no beauty ratings that are 0.***
...
***The linear model is:***
***score = 4.09 + 0.14***
***A male subject on average scores 0.14 higher on evaluations than a female professor. On average, a female professor scores 4.09 on the ratings.***
...
```
***the model is***
***score= 4.28 - 0.12xTenure Track - 0.14x Tenured***
...
***The average rating for a tenured professor is 4.14. The average rating for a teaching professor is 0.14 points higher than a tenured professor. The average rating for a tenure track is 0.02 points higher than a tenured professor.***
